...
public class TweetApp {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Tweet APP Api",
				...
				"1.0", "Free to use",
				new springfox.documentation.service.Contact("Tarun Prajapat", "https://github.com/TarunPrajapat",
						"tarunprajapat969@gmail.com"),
				"TP license", "https://github.com/TarunPrajapat", Collections.emptyList());
	}
